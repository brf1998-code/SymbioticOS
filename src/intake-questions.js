...
const FIXED = [
  { id: "name", kind: "text", required: true, multiline: false, max: 60,
    text: "What should we call it?",
    hint: "A short name people on the floor would use. It can change later." },
  { id: "purpose", kind: "text", required: true, multiline: true, max: 2000,
  ...
  { id: "thing", kind: "text", required: true, multiline: false, max: 80,
  ...
  { id: "stages", kind: "order", required: true, min: 2, max: 12,
  ...
  { id: "wrong", kind: "items", required: true, min: 1, max: 3, item_max: 200,
    text: "What goes wrong today that this should stop?",
    hint: "Up to three things. The ones that cost time, cause arguments, or get somebody a call at home." },
  { id: "never", kind: "text", required: true, multiline: true, max: 1500,
